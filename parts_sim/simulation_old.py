...
data = np.load("../dj/OceanClustering/ND_rwcnorm_"+str(ngmm)+".npy") # mean GMM class 1 data (just as example), output from table.ipynb
print(data.shape)
...
f_nat.savefig('../img/nat_passive_clwp200.3freq.v1.png',dpi=300)
...
plt.plot(rr_h[:-1], stds_dbz[:,0], label='Ku')
plt.plot(rr_h[:-1], stds_dbz[:,1], label='Ka')
