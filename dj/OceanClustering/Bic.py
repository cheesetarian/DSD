...
def main(address, filename_raw_data, subsample_bic, fraction_train, repeat_bic, max_groups, grid_bic,\
    ...
    for i in range(0,repeat_bic):
        print("Starting ", i)
        bic = bic_oneRun(address, filename_raw_data, subsample_bic, fraction_train, repeat_bic, max_groups, grid_bic,\
                   conc_bic, size_bic, n_dimen, fraction_nan_samples, fraction_nan_depths, dtype)
        bic_many[i,:] = bic[0]
    ...
    #print('n_mean,n_stdev ',n_mean,n_stdev)
